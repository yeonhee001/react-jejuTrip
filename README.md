...
| 문서종류 | 파일명 | 설명 |
| :---:| :---: | :---: |
| 기획서 | [기획서.pdf]() | 프로젝트 목적, 타겟, 주요 기능 등 기획 개요 |
| 화면설계 | [화면설계.pdf]() | 주요 페이지의 화면 구성, 사용자 흐름 등 와이어프레임 기반 설계 자료 |
| 디자인 | [디자인.pdf]() | Figma로 작업한 디자인 시안. 색상, 폰트, UI 요소 등 자료 |
| 발표자료 | [발표자료.pdf]() | 팀 프로젝트 발표용 슬라이드 자료 |
| 인터페이스 기능 보고서 |  | 구현된 기능별 상세 설명 |
| 완료 보고서 | [완료보고서.hwp]() | 프로젝트 진행 결과 요약 등 최종 보고 |
