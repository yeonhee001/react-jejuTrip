...
## 🧩 공통 컴포넌트 제작
* 📜Menu.jsx - 모든 페이지 하단에 공통 메뉴바를 놓기 위한 컴포넌트
* 📜Header.jsx - 모든 페이지 상단에 공통 헤더를 놓기 위한 컴포넌트
* 📜Burger.jsx - 헤더에 포함되어있는 리스트 버튼 클릭 시 나타나는 버거 컴포넌트
* 📜PlaceItem.jsx - 여행지 컨텐츠를 사용하는 페이지에서 사용되는 장소 컨텐츠 컴포넌트
* 📜Like.jsx - 여행지 컨텐츠에서 하트를 클릭했을 때 변경되는 하트 컴포넌트
* 📜MoreBtn.jsx - 여행지 리스트 페이지로 이동할 수 있는 전체보기 컴포넌트
* 📜TopBtn.jsx - 리스트가 길게 나열되어 있는 페이지에서 사용되는 탑 버튼 컴포넌트
